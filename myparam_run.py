...
if not __name__ == "__main__":
    ...
    if config.board == "old":
        ...
        ### Trigger -- Fr:15, FrLH:13, RrLH:35, FrRH:32, RrRH:36
        config.t_list = [15, 13, 35, 32, 36]
        config.ultrasonics_dict_trig = {
            "Fr": config.t_list[0],
            "FrLH": config.t_list[1],
            "RrLH": config.t_list[2],
            "FrRH": config.t_list[3],
            "RrRH": config.t_list[4],
        }
        config.ultrasonics_dict_echo = {
            "Fr": config.e_list[0],
            "FrLH": config.e_list[1],
            "RrLH": config.e_list[2],
            "FrRH": config.e_list[3],
            "RrRH": config.e_list[4],
        }
        ...
        config.ultrasonics_dict_trig = {
            "Fr": config.t_list[0],
            "FrRH": config.t_list[1],
            "FrLH": config.t_list[2],
            "RrRH": config.t_list[3],
            "RrLH": config.t_list[4],
        }
        config.ultrasonics_dict_echo = {
            "Fr": config.e_list[0],
            "FrRH": config.e_list[1],
            "FrLH": config.e_list[2],
            "RrRH": config.e_list[3],
            "RrLH": config.e_list[4],
        }
